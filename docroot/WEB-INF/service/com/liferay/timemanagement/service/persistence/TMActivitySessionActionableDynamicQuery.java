 ...
 * @generated
 */
public abstract class TMActivitySessionActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public TMActivitySessionActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TMActivitySessionLocalServiceUtil.getService());
		setClass(TMActivitySession.class);

		setClassLoader(com.liferay.timemanagement.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("activitySessionId");
	}
}