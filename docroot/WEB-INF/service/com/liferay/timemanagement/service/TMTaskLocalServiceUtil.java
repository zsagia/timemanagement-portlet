...
public class TMTaskLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<com.liferay.timemanagement.model.TMTask> getTaskByC_T(
		long companyId, long taskId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getTaskByC_T(companyId, taskId);
	}

	public static java.util.List<com.liferay.timemanagement.model.TMTask> getTaskByC_T_F(
